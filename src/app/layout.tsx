    ...
    // ══ FAQ ══
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { '@type': 'Answer', text: 'Binanızın veya mekanınızın fotoğrafını yükleyin, istediğiniz taş modelini seçin. Yapay zeka (Google Gemini + Replicate nano-banana-pro), taşın binaya nasıl görüneceğini fotogerçekçi olarak simüle eder. Ücretsizdir, günlük 3 simülasyon hakkınız vardır.' },
        },
        {
          '@type': 'Question',
