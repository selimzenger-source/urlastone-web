  ...
  const { error: createError } = await supabaseAdmin.rpc('exec_sql', {
    query: `
      CREATE TABLE IF NOT EXISTS hero_slides (
        ...
        subtitle_de text DEFAULT '',
        gold_tr text DEFAULT '',
        gold_en text DEFAULT '',
        gold_es text DEFAULT '',
        gold_ar text DEFAULT '',
        gold_de text DEFAULT '',
...
CREATE TABLE IF NOT EXISTS hero_slides (
  ...
  image_url text NOT NULL,
  bg_position text DEFAULT 'center center',
  tag_tr text DEFAULT '', tag_en text DEFAULT '', tag_es text DEFAULT '', tag_ar text DEFAULT '', tag_de text DEFAULT '',
  subtitle_tr text DEFAULT '', subtitle_en text DEFAULT '', subtitle_es text DEFAULT '', subtitle_ar text DEFAULT '', subtitle_de text DEFAULT '',
  gold_tr text DEFAULT '', gold_en text DEFAULT '', gold_es text DEFAULT '', gold_ar text DEFAULT '', gold_de text DEFAULT '',
  desc_tr text DEFAULT '', desc_en text DEFAULT '', desc_es text DEFAULT '', desc_ar text DEFAULT '', desc_de text DEFAULT '',
  sort_order integer DEFAULT 0,
  active boolean DEFAULT true,
  created_at timestamptz DEFAULT now()
);
