  ...
  return NextResponse.json({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Our free AI-powered tool lets you upload a photo of your building or room, select a stone type and pattern, and see a photorealistic preview of how the stone will look applied. Uses Google Gemini and Replicate nano-banana-pro models. Daily limit: 3 simulations. Available at urlastone.com/simulasyon in 7 languages.',
      },
      {
